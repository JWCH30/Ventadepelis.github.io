...
if (isset($_POST['textfield'])) {
  ...
  $MM_redirectLoginSuccess = "Siinicio.html";
  $MM_redirectLoginFailed = "Noinicio.html";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_registro, $registro);
  
  $LoginRS__query=sprintf("SELECT Usuario, Clave FROM usuarios_datos WHERE Usuario=%s AND Clave=%s",
...
<div class="container">
  <div class="content">
    <p align="center">&nbsp;</p>
    <div align="center">
      <table width="662" height="201" border="0" cellpadding="5" cellspacing="10">
        <tr>
          <td height="54"><h2 align="center">Inicia sesion para acceder a mas contenido</h2></td>
        </tr>
        <tr>
          <td> <div align="center">
            <h3>Usuario: </h3>
          </div>            <form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
              <p align="center">
